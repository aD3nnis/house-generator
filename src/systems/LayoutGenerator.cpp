...
float LayoutGenerator::get_min_room_variation() { return MIN_ROOM_VARIATION; }
float LayoutGenerator::get_max_room_variation() { return MAX_ROOM_VARIATION; }
...
vector<float> LayoutGenerator::distributePercent(int room_count,
                                                 float totalPercent,
...
float LayoutGenerator::randomWeight(LayoutGenerator &layout_gen) {
  ...
  return layout_gen.get_min_room_variation() +
         t * (layout_gen.get_max_room_variation() -
              layout_gen.get_min_room_variation()); // random weight between
                                                    // MIN_ROOM_VARIATION and
                                                    // MAX_ROOM_VARIATION
};
