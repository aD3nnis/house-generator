...
// dots mean empty - eventually i should put space as empty but for now visually
// i can see it better
class Grid {
private:
...
public:
  ...
  void set_coordinates(
      map<tuple<int, int>, char> &coordinates_copy) { // coordinate nickname
