1. make grid dynamic for user experience (hopefully less scrolling up)
2. for placement: account for attaching full room size not side just side of room your attching to.
...
7. attching multiple rooms to one side if length of door is available. 